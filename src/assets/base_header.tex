...
% --- Section header styling (titlesec modern equivalent) ---
\titleformat*{\section}{\color{astral}\normalfont\sffamily\bfseries\Large}
\titleformat*{\subsection}{\color{astral}\normalfont\sffamily\bfseries\large}
\titleformat*{\subsubsection}{\color{astral}\normalfont\sffamily\bfseries\normalsize}
